...
FONT_PATH = os.environ.get("WORDMARK_FONT", "/usr/share/fonts/noto/NotoSans-Bold.ttf")
...
TEXT = os.environ.get("WORDMARK_TEXT", "FARRUKH")
...
def emit(frames, mode, out, dur, reveal):
    ...
    p.append(f'<text x="{canvas_w/2:.0f}" y="{TITLEBAR_H/2 + 4:.0f}" fill="{TITLE_TEXT}" '
             f'font-size="11.5" text-anchor="middle">farrukh@github: ~$ ./wordmark.sh --3d</text>')
